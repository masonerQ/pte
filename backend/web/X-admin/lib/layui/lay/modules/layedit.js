                ...
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        ...
                        elem: e(l).find("input")[0],
                            ...
                            (s.successCode ? s.successCode : 200) == e.code ? (e.data = e.data || {}, h.call(t, "img", {
                                src: e.data.src,
                                alt: e.data.title
                            }, n)) : i.msg(e.msg || "上传失败")
                        }
                    ...
                    success: function (n, l) {
                        layui.use("upload", function (o) {
                            ...
                            o.render({
                                ...
                                size: u.size,
                                before: function (t) {
                                    s = i.msg("文件上传中,请稍等哦b", {icon: 16, shade: .3, time: 0})
                                },
                                done: function (t, e, n) {
                    ...
                    success: function (l, o) {
                        layui.use("upload", function (s) {
                            ...
                            s.render({
                                ...
                                size: d.size,
                                before: function (t) {
                                    r = i.msg("文件上传中,请稍等哦c", {icon: 16, shade: .3, time: 0})
                                },
                                done: function (t, e, n) {
                                ...
                                size: f.size,
                                before: function (t) {
                                    r = i.msg("文件上传中,请稍等哦d", {icon: 16, shade: .3, time: 0})
                                },
                                done: function (t, e, n) {
                        ...
                        success: function (n, l) {
                            ...
                            return layui.use("upload", function (t) {
                                ...
                                t = layui.upload, t.render({
                                    ...
                                    size: o.size,
                                    before: function (t) {
                                        e = i.msg("文件上传中,请稍等哦a", {icon: 16, shade: .3, time: 0})
                                    },
                                    done: function (t, n, o) {
