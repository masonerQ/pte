        ...
        <div class="layui-row">
            <form class="layui-form" method="post" id="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_title" name="title" required="" lay-filter="title" lay-verify="title" autocomplete="off" class="layui-input"
                               value="<?= $model->title; ?>"/>
                    </div>
                        ...
                        <div class="layui-upload">
                            ...
                            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                <div class="layui-upload-list" id="video_cover_preview">
                                    <img width="115" height="100" src="<?= $model->title; ?>" alt="" class="layui-upload-img"/>
                                </div>
                            </blockquote>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 250px;">
                        <input readonly type="text" id="L_video_link" name="video_link" required="" lay-filter="video_link" lay-verify="video_link" autocomplete="off" class="layui-input"
                        ...
                        <div class="layui-upload">
                            ...
                            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                <div class="layui-upload-list" id="video_link_preview">
                                    <video controls="controls" width="115" height="100" src="<?= $model->audio_link; ?>" alt="" class="layui-upload-img"/>
                                </div>
                            </blockquote>
                        </div>
                    </div>
