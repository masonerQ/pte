    ...
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form" method="post" id="layui-form">
                ...
                <?php if (in_array($Cate->id, [6, 18, 8, 14, 15, 19])): ?>
                    <div class="layui-form-item">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-form-mid layui-word-aux" style="margin-left: 110px;">
                        <span class="x-red"></span><?php if (in_array($Cate->id, [11, 12, 13])): ?>答案请用英文逗号隔开,例如: xxx#ttt#bbb#ccc    当中的#号请一定输入英文的#号<?php else: ?><?php endif; ?>
                    </div>
                </div>
