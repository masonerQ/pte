        ...
        <div class="layui-row">
            <form class="layui-form" method="post" id="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_article_name" name="article_name" required="" lay-filter="article_name" lay-verify="article_name" autocomplete="off" class="layui-input"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea type="text" id="L_article_content" name="article_content" required="" lay-filter="article_content" lay-verify="article_content" autocomplete="off"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="nivo" checked="" lay-skin="switch" lay-text="是|否" value="1">
                    </div>
                </div>
