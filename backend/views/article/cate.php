        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <!--</div>-->
                    <div class="layui-card-header">
                        <button class="layui-btn" onclick="xadmin.open('添加分类','cate-add.html', 600, 400)"><i class="layui-icon"></i>添加分类</button>
                    </div>
                    <div class="layui-card-body ">
                                ...
                                <tr cate-id='<?= $value['id']; ?>' fid='<?= $value['parent_id']; ?>'>
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn layui-btn-xs"
                                                onclick="xadmin.open('编辑','cate-edit.html?id=<?= $value['id']; ?>', 600, 400)">
                                ...
                                <?php if ($value['child']): ?>
                                    <?php foreach ($value['child'] as $ke => $val): ?>
                                        <tr cate-id='<?= $val['id']; ?>' fid='<?= $val['parent_id']; ?>'>
                                            ...
                                            <td class="td-manage">
                                                <button class="layui-btn layui-btn layui-btn-xs"
                                                        onclick="xadmin.open('编辑','cate-edit.html?id=<?= $val['id']; ?>', 600, 400)">
                                                    <i class="layui-icon">&#xe642;</i>编辑
                                                </button>
                                                <!--<button class="layui-btn layui-btn-warm layui-btn-xs" onclick="xadmin.open('编辑','admin-edit.html')">-->
                                                <!--    <i class="layui-icon">&#xe642;</i>添加子栏目-->
